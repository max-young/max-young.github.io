...
- [答疑](#答疑)
  ...
  - [keep a empty directory in git](#keep-a-empty-directory-in-git)
- [工作流](#工作流)
  - [工作流参考资料](#工作流参考资料)
  - [分支管理](#分支管理)
  - [流程](#流程)
...
#### keep a empty directory in git

Git does not track empty directories. To keep an empty directory in git, you can create a placeholder file inside the directory, commonly named `.gitkeep`.
